...
/**
 * components/ui/dialog.tsx · shadcn/ui Dialog (new-york，精简版)
 *
 * 用于二次确认（删除 Stage / Application 等）。
 */
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-card-lg bg-surface-bg p-6 shadow-hover",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          "text-text-tertiary hover:bg-soft-panel hover:text-text-primary",
